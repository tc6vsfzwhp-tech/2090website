  ...
  return (
    ...
    >
      ...
      <div className="sticky bottom-0 flex justify-center z-50 pointer-events-none">
        <div className="relative w-[90vw] md:w-[85vw] lg:w-[1000px] max-w-[1000px] min-[1920px]:w-[1200px] min-[1920px]:max-w-[1200px] min-[2560px]:w-[1500px] min-[2560px]:max-w-[1500px]">
